...
let secureApi = jwt({
    secret: jwks.expressJwtSecret({
        ...
        jwksUri: "https://broomspun.auth0.com/.well-known/jwks.json"
    }),
    audience: 'https://angel-auth.herokuapp.com/',
    issuer: "https://broomspun.auth0.com/",
    algorithms: ['RS256']
});

const checkScopes = jwtAuthz([ 'read:courses', 'read:api/courses' ]);
...
/* GET courses listing. */
router.get('/courses', secureApi, checkScopes, (req, res, next) => {
    let courses = [
        {
            "id": 1,
